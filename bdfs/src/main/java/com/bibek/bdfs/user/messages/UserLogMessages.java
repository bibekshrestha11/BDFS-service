...
public class UserLogMessages {
    ...
    public static final String USER_UPDATE_REQUEST_RECEIVED = "User update request received";
    ...
    public static final String USER_REGISTRATION_REQUEST_RECEIVED = "User registration request received";
}